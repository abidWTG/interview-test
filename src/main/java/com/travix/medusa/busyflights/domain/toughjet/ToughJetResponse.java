...
public class ToughJetResponse implements Comparable<ToughJetResponse> {
    ...
    @Override
    public int compareTo(ToughJetResponse o) {
        return new Double(o.getBasePrice()).compareTo(this.getBasePrice());
    }
}
