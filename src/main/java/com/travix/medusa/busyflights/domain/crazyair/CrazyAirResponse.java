...
public class CrazyAirResponse extends FlightParent implements Comparable<CrazyAirResponse> {
    ...
    @Override
    public int compareTo(CrazyAirResponse o) {
        return new Double(o.getPrice()).compareTo(this.getPrice());
    }
}
